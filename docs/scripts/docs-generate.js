...
const componentFolders = glob.sync(`../node_modules/optimizely-oui/src/@(${categories.join('|')})/**/`, {
  ignore: [
    '../node_modules/optimizely-oui/src/components/', 
    '../node_modules/optimizely-oui/src/overrides/',
    '../node_modules/optimizely-oui/**/tests/*', '../node_modules/optimizely-oui/**/tests/',
    '../node_modules/optimizely-oui/**/example/', '../node_modules/optimizely-oui/**/Icon/*',
    '../node_modules/optimizely-oui/**/Icon/'],
});
...
componentFolders.map(filePath => {
  ...
  const componentName = filePath.substring(0, filePath.length - 1).replace(`../node_modules/optimizely-oui/src/${categoryName}/`, '');
  ...
  if (reactComponentPaths && reactComponentPaths.component) {
    ...
    writeFile(`src/data/${categoryName}/${componentName}/react.json`, JSON.stringify(reactComponentData));
  }
  ...
  if (files[categoryName][componentName].path.properties) {
    ...
    writeFile(`src/data/${categoryName}/${componentName}/properties.json`, JSON.stringify(yamlComponentData));
  }
  ...
  //     writeFile(`src/data/${categoryName}/${componentName}/sass.json`, JSON.stringify(sassComponentData));
  //   });
  // }
});

writeFile('src/data/index.json', JSON.stringify(files));
