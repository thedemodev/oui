...
function (_React$Component) {
  ...
  function Sortable(props) {
    ...
    var coercedItems = Immutable.List.isList(_items) ? _items : Immutable.fromJS(_items);
  ...
  _createClass(Sortable, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (!currentAllowGrouping) {
        var coercedNewItems = Immutable.List.isList(this.props.defaultValue) ? this.props.defaultValue : Immutable.fromJS(this.props.defaultValue);
    ...
    value: function render() {
      ...
      return React.createElement("div", {
      ...
      }, React.createElement(SortableGroup, {
        items: items,
        ...
        id: "root"
      }), React.createElement(SortDragLayer, {
        renderItem: renderItem,
        baseTestSection: testSection
      }));
    }
...
_defineProperty(Sortable, "propTypes", {
   ...
   */
  defaultValue: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.oneOfType([PropTypes.shape({
...
export var UnwrappedSortable = Sortable;
