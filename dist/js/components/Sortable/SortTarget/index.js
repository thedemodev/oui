...
_defineProperty(SortTarget, "propTypes", {
  ...
  ownerId: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].number]).isRequired,
  ownerType: _propTypes["default"].oneOf(['item', 'group']).isRequired,
  position: _propTypes["default"].arrayOf(_propTypes["default"].number).isRequired
});

var _default = (0, _reactDnd.DropTarget)(_draggableTypes["default"].item, {
  hover: handleHover
