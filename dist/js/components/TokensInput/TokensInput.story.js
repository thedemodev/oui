...
TokensInput.propTypes = _index["default"].propTypes;
TokensInput.defaultProps = _index["default"].defaultProps;
(0, _react2.storiesOf)('TokensInput', module).addDecorator(_addonKnobs.withKnobs).addDecorator(function (story) {
  return _react["default"].createElement("div", {
    id: "root-preview"
  }, story());
}).add('Default', function () {
  return _react["default"].createElement(TokensInput, {
    onChange: (0, _addonActions.action)('tokens changed'),
    tokens: SAMPLE_DATA
  });
