...
var propTypes = {
  ...
  */
  border: _propTypes["default"].oneOf(['top', 'bottom', 'left', 'right', 'sides', 'ends', 'all', 'none']),

  /**
   * Display layout as vertical column.
  */
  displayVertical: _propTypes["default"].bool,
   ...
   */
  overflow: _propTypes["default"].oneOf(['none', 'overflow-y--scroll', 'overflow-x--auto', 'overflow-y--auto']),
   ...
   */
  removeGutters: _propTypes["default"].bool,
...
var Row = _react["default"].forwardRef(function (_ref, ref) {
  ...
  return _react["default"].createElement(Component, _extends({}, props, {
    className: (0, _classnames["default"])('row', classes, removeGutters && 'gutters--remove')
  }));
});
